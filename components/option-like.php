...
?>
    <div class="bg-[#f7f7f7] pt-1 pb-1 pl-3 pr-3 bottom-shadow items-center border-1 border-b-solid border-gray-100 <?php echo ($agree > 0 ? 'flex' : 'hidden'); ?> like-agree-<?php echo $this->cid; ?>">
        ...
        <span class="text-[14px] ">
            ...
            <span class="text-color-link text-[14px]">
                <span class="fk-cid-<?php echo $this->cid; ?>"><?php echo $agree; ?></span> 位访客
            </span>
        </span>
    </div>
