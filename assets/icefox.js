...
function printCopyright(){
    console.log('%cIcefox主题 By xiaopanglian v1.7.0 %chttps://0ru.cn', 'color: white;  background-color: #99cc99; padding: 10px;','color: white; background-color: #ff6666; padding: 10px;');
}
