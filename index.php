...
<div class="container bg-white pyq-container">
    ...
    <!--    时间<time datetime="-->
    <?php //$this->date('c'); ?><!--" itemprop="datePublished" class="underline text-[#f59e0b]">-->
    <?php //$this->date('m.d'); ?><!--</time>-->
    <!--中间内容区-->
    <div class="mt-6">
        <?php while ($this->next()) : ?>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute right-16 top-[-10px] bg-[#4b5153] flex flex-row justify-center items-center rounded-lg commentTip hidden">
                                ...
                                <div class="flex flex-row justify-center items-center ml-5 mr-5 cursor-pointer comment-btn"
                                     data-respondId="<?php $this->respondId(); ?>" data-id="<?php $this->cid(); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" baseProfile="full"
                                         width="18" height="18" viewBox="0 0 512 512"
                                    >
